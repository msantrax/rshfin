...
public class Dose_pf extends Entity {

    private static final Logger log = Logger.getLogger(Dose_pf.class.getName());
    ...
    private static Dose_pf instance;
    public static Dose_pf getInstance(Long parent){

        Object temp;
        instance = new Dose_pf();
        ...
        if (ed1 != null){
            instance = (Dose_pf)ed1.getInstance();
