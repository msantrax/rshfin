...
public class Point_pf extends Entity {

    private static final Logger log = Logger.getLogger(Point_pf.class.getName());
    ...
    private static Point_pf instance;
    public static Point_pf getInstance(Long parent){

        Object temp;
        instance = new Point_pf();
        ...
        if (ed1 != null){
            instance = (Point_pf)ed1.getInstance();
